...
// all the buttons
var aBtns1 = document.querySelectorAll('#navs li');

// onmouseover event handler
addEvent(aBtns1, 'mouseover', function (event) {
    aLoops[1].currentTime = 0;
    aLoops[1].play(); // play click sound
});

// onmouseout event handler
addEvent(aBtns1, 'mouseout', function (event) {
    aLoops[1].currentTime = 0;
    aLoops[1].pause(); // play click sound
});

// onclick event handler
addEvent(aBtns1, 'click', function (event) {
